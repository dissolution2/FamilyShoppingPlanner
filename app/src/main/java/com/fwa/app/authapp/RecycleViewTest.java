...
public class RecycleViewTest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(RecycleViewTest.this,UserList.class));
                finish();
            }
        });
...
*/
        ...
        UserTwo userTwo = new UserTwo(username, useremail, userage);
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if(task.isSuccessful()) {
                            Toast.makeText(RecycleViewTest.this, "User details Inserted", Toast.LENGTH_SHORT).show();
